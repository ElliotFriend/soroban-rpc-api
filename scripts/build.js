...
let cdBase = "src/contentDescriptors/";
...
let epoBase = "src/examplePairingObjects/"
...
fs.writeFileSync('refs-openrpc.json', JSON.stringify(doc, null, 2));
